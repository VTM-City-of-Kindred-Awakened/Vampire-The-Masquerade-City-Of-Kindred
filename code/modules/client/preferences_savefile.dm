...
//		clane = new newtype()
	...
	discipline1type				= sanitize_inlist(discipline1type, subtypesof(/datum/discipline))
	discipline2type				= sanitize_inlist(discipline2type, subtypesof(/datum/discipline))
	discipline3type				= sanitize_inlist(discipline3type, subtypesof(/datum/discipline))
	discipline4type				= sanitize_inlist(discipline1type, subtypesof(/datum/discipline))
