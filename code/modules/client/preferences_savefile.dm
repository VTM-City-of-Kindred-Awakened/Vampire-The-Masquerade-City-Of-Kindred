...
//		clane = new newtype()
	...
	discipline1type				= sanitize_inlist(discipline1type, subtypesof(/datum/discipline), initial(discipline1type))
	discipline2type				= sanitize_inlist(discipline2type, subtypesof(/datum/discipline), initial(discipline2type))
	discipline3type				= sanitize_inlist(discipline3type, subtypesof(/datum/discipline), initial(discipline3type))
	if(discipline4type)
		discipline4type				= sanitize_inlist(discipline4type, subtypesof(/datum/discipline), initial(discipline4type))
