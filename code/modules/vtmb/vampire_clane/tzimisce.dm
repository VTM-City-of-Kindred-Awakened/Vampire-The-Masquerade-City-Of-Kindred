...
//	no_facial = TRUE	//FUCK WRONG RULEBOOK
	...
	enlightement = TRUE
	whitelist = list("badteammate", "meomoor", "terain1", "egorium", "vanotyan", "takyon69", "lemshake", "happypala44", "kerststf", "oneplusone", "triplewammy", "frydoza", "leonko", "twiner", "sishtis", "shirumic", "kommando", "nehoroshka", "raikyh", "themaskedman2", "xilvahphyre", "nikroszero", "foxfiredogs", "omegazip2", "d6ll1r10um", "drdreidel", "stinkethstonketh", "neepbeep666", "parchment", "blackcat055", "laoziofcitium", "aniotaess", "andreykey", "mosasauruss", "animusin", "mercuryarrow", "keebo885", "homuhomu", "ivanzarax", "testuser", "ntno", "athiny", "jacobmadson", "ceoofbutter", "psewdoplot", "cmdrgungnir", "fallen1220", "dyzennon", "templeosdavis", "fourty2", "theshroudedlord", "pakoooisthere", "feudeytf", "gruesomeborg68915", "deendoor24", "darkincarnate", "tonybito", "arwendarethis", "enigmur", "swatogor", "zickzack", "noxesdeadwish", "yecrowbarman", "heimy", "sockfan", "dyzennon", "rebelfarming", "serotoninsyndrome", "pluviifera", "dangitmaster", "justben201", "topbirb", "owlsthegod")
	var/obj/item/heirl
