...
GLOBAL_LIST_INIT(donaters, list("badteammate", "meomoor", "terain1", "egorium", "vanotyan", "takyon69", "lemshake", "happypala44", "kerststf", "oneplusone", "leonko", "twiner", "otuskursky", "sishtis", "shirumic", "kommando", "nehoroshka", "raikyh", "themaskedman2", "xilvahphyre", "nikroszero", "foxfiredogs", "d6ll1r10um", "drdreidel", "stinkethstonketh", "neepbeep666", "parchment", "blackcat055", "laoziofcitium", "aniotaess", "andreykey", "mosasauruss", "animusin", "mercuryarrow", "keebo885", "homuhomu", "ivanzarax", "testuser", "cmdrgungnir", "psewdoplot", "dyzennon", "looptyloo", "heimy", "notaspider", "fourty2", "mormaethor", "odin933", "feudeytf", "awakethedemon", "noxesdeadwish", "ifrickfracki", "gruesomeborg68915", "asskek", "suriyel", "kayzach", "darkincarnate", "weredeaddeeds", "tonybito", "darkrixd", "justben201", "redruse", "deendoor24", "ambrosiafumari", "0nemore", "dangitmaster", "kirichi"))
